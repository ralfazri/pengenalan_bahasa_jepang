...
import com.beasiswa.app.bahasajepang.databinding.ActivityLetsPlayBinding
import com.beasiswa.app.bahasajepang.databinding.ItemGambarAdapterBinding
...
class LetsPlayActivity : AppCompatActivity() {
    ...
    //deklarasi variabel untuk menampung reource yang akan di pakai
    ...
    //deklarasi variabel untuk event ketika di swipe ke kiri/kanan
    private val  onPageListener = object: ViewPager.OnPageChangeListener{
        ...
        override fun onPageSelected(position: Int) {
            //ketika si halaman dimunculkan/terpilih
            startAudio(position)
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //berfungsi untuk memberikan si viewPager agar bisa
        //memndeteksi apakah halamannya terganti/berganti
    ...
    fun destroyMediaPlayer(){
        //check dulu apakah media player is null
    ...
    private inner class AdapterGambar: PagerAdapter(){
        ...
        override fun instantiateItem(container: ViewGroup, position: Int): Any {
            ...
            //set angka sesuai dengan halaman sekarang
            binding.huruf.text = angka[position]

            //kasih klik untuk ikon replay, buat putar ulang suara
